...
<html lang="en">
    <head>
        ...
        <title>Portofolio Amir Santoso</title>
    </head>
    <body>
        <!--===== HEADER =====-->
        <header class="l-header">
            <nav class="nav bd-grid">
                <div>
                    <a href="#" class="nav__logo">Portofolio Amirsantoso</a>
                </div>
        ...
        <main class="l-main">
            ...
            <section class="home bd-grid" id="home">
                <div class="home__data">
                    <h1 class="home__title">Hi,<br>Nama Saya <span class="home__title-color">Amir</span><br>Santoso</h1>
            ...
            <section class="about section " id="about">
                ...
                <div class="about__container bd-grid">
                    ...
                    <div>
                        <h2 class="about__subtitle">Nama Saya Amir Santoso</h2>
        ...
        <!--===== FOOTER =====-->
        <footer class="footer">
            <p class="footer__title">Amir Santoso</p>
            <div class="footer__social">
                <a href="#" class="footer__icon"><i class='bx bxl-facebook' ></i></a>
                <a href="#" class="footer__icon"><i class='bx bxl-instagram' ></i></a>
                <a href="#" class="footer__icon"><i class='bx bxl-twitter' ></i></a>
            </div>
            <p>Copyright &copy; <font color="red" alt="amirsantoso.heroku.com">amirsantoso.herokuapp.com</font> & <font color="red" alt="amirsantoso">Amir Santoso</font></p>
        </footer>
